 ...
 * the License.
 */
package org.seasar.maya.test.util.servlet.jsp.tagext;
 ...
 */
public class TestBodyContent extends BodyContent implements CONST_IMPL {
    ...
    public TestBodyContent(JspWriter enclosingWriter) {
