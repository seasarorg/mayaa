...
public class FinalNamespace extends NamespaceImpl implements Namespace {
    ...
    private static Map _namespaces = new WeakValueHashMap(0);
    ...
    private static String forNamespaceString(
            Namespace namespace, boolean allPrefixes) {
        if (namespace == null) {
            return "null";
        }
    ...
    private static String forNamespaceString0(
            Namespace namespace, boolean allPrefixes) {
        StringBuffer sb = new StringBuffer();
        sb.append("prefixes={");
    ...
    private static String forNamespaceString1(Iterator prefixMappingIterator) {
        ...
        while (prefixMappingIterator.hasNext()) {
            PrefixMapping prefixMapping =
                    (PrefixMapping) prefixMappingIterator.next();
    ...
    private FinalNamespace(Namespace copyFrom) {
        ...
        try {
            Namespace parentNamespace =
                    getFinalInstance(copyFrom.getParentSpace());
            ...
            while (it.hasNext()) {
                ...
                addPrefixMapping(
                        prefixMapping.getPrefix(),
                        prefixMapping.getNamespaceURI());
            }
    ...
    protected PrefixMapping createPrefixMapping(
        ...
        return super.createPrefixMapping(prefix, namespaceURI);
    }
